...
| 菜单栏 | `frontend-vue/src/components/MenuBar.vue` |
| 工具栏 | `frontend-vue/src/components/ToolBar.vue` |
...
| 图集面板 | `frontend-vue/src/components/AtlasPanel.vue` |
| 画布 | `frontend-vue/src/components/CanvasArea.vue` |
